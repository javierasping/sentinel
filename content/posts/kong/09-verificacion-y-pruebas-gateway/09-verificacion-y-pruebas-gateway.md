...
**Artículo anterior:** [Primeros Pasos: Servicios y Rutas](/posts/kong/08-servicios-y-rutas-basicos/08-servicios-y-rutas-basicos/)
**Resumen de la serie:** Has completado la guía de instalación y configuración básica de Kong Gateway. Ahora estás listo para explorar la implementación de Plugins avanzados.
